...
private[""_msg"",""_to""];
	...
	hint format[""Du hast eine Nachricht an die Notärzte geschickt."",_to,_msg];
	ctrlShow[3022,true];
";
//To One Person
fnc_cell_textmsg =
compileFinal "
	...
	ctrlShow[3015,false];
	_msg = ctrlText 3003;
	if(lbCurSel 3004 == -1) exitWith {hint ""Bitte wähle einen Spieler aus, an den du eine Nachricht versenden möchtest!""; ctrlShow[3015,true];};
...
compileFinal "
	...
	[] call life_fnc_cellphone;
	hint format[""Admin-Nachricht versendet an: %1 - Nachricht: %2"",name _to,_msg];
";
...
compileFinal "
	...
	[] call life_fnc_cellphone;
	hint format[""Globale Admin-Nachricht versendet: %1"",_msg];
";
...
compileFinal "
	...
	switch (_type) do
	{
		case 0 :
		{
			...
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Neue SMS<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>You<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			[""TextMessage"",[format[""Du hast eine neue SMS von %1 erhalten"",_from]]] call bis_fnc_showNotification;
			systemChat _message;
		};
		...
		case 1 :
		{
			...
			private[""_message""];
			_message = format[""Neuer Notruf von %1: %2"",_from,_msg];
			hint parseText format [""<t color='#316dff'><t size='2'><t align='center'>Neuer Notruf!<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Einheiten<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			[""PoliceDispatch"",[format[""Neuer Notruf eingegangen: %1"",_from]]] call bis_fnc_showNotification;
			systemChat _message;
		};
		...
		case 2 :
		{
			...
			hint parseText format [""<t color='#ffcefe'><t size='2'><t align='center'>Admin Request<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Chaotentrupp-Admins<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
			
			[""AdminDispatch"",[format[""%1 benötigt Admin-Unterstützung!"",_from]]] call bis_fnc_showNotification;
			systemChat _message;
		};
		...
		case 3 :
		{
			...
			hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Admin Nachricht<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Dich<br/><t color='#33CC33'>Von: <t color='#ffffff'>Chaotentrupp-Admins<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
		...
		case 4 :
		{
			...
			_message = format[""!!!Admin Nachricht: %1"",_msg];
			_admin = format[""von Admin: %1"", _from];
			hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Admin Nachricht<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Spieler<br/><t color='#33CC33'>Von: <t color='#ffffff'>Chaotentrupp-Admins<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
		...
		case 7: {
			...
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Anfrage Notarzt<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Dich<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];

			[""TextMessage"",[format[""Neuer Notruf von: %1"",_from]]] call bis_fnc_showNotification;
		};
