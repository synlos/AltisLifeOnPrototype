...
diag_log format["Loading @extDB ..."];
_version = "extDB" callExtension "9:VERSION";
if(_version == "") exitWith {life_server_extDB_notLoaded = true; publicVariable "life_server_extDB_notLoaded";diag_log format["Loading @extDB FAILED"];};

diag_log format["Loading @extDB SUCCESS"];
