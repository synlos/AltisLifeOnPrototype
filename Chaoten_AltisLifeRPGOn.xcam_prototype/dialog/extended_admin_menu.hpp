...
class life_extended_admin_menu {
	...
	class controls 
	{
		...
		class player_b_tpTo: Life_RscButtonMenu
		{
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "Zum Spieler hinporten";
			onButtonClick = "[] spawn life_fnc_adminTpTo;";
		};
		class player_b_tpMap: Life_RscButtonMenu
		{
			idc = 2412;
			text = "TpMap";
			x = 30.5 *  GUI_GRID_W + GUI_GRID_X;
			...
			w = 4 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
			tooltip = "auf Map Porten";
			onButtonClick = "[] spawn life_fnc_adminTpMap;";
		};
