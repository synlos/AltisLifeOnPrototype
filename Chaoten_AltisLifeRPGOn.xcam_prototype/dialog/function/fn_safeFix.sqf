...
if(!(_vault getVariable["safe_open",false])) exitWith {hint "Ist der Tresor schon verschlossen?"};
...
hint "Der Tresor der Staatsbank ist nun repariert und das Geld ist Sicher!";