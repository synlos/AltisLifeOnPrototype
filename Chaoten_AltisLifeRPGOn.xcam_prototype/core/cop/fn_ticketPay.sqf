...
if(life_cash < life_ticket_val) exitWith
{
	...
	{
		hint "Du hast nicht genügend Geld auf deinem Konto oder in Bar um das Bußgeld bezahlen zu können!";
		[[1,format["%1 konnte das Bußgeld nicht bezahlen.",profileName]],"life_fnc_broadcast",life_ticket_cop,false] spawn life_fnc_MP;
		closeDialog 0;
	};
	hint format["Du hast das Bußgeld über $%1 bezahlt!",[life_ticket_val] call life_fnc_numberText];
