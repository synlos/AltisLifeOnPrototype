...
{
	case "C_Quadbike_01_F":				{ 	_lightleft lightAttachObject [_vehicle, [-0.28, 0.8, -0.75]];};
	...
	case "B_Truck_01_covered_F":  		{	_lightleft lightAttachObject [_vehicle, [-0.92, 5, -0.45]];};
	case "O_MRAP_02_F":  				{	_lightleft lightAttachObject [_vehicle, [-1.08, -1.6, 0.35]];};
	case "O_MRAP_02_hmg_F":  			{	_lightleft lightAttachObject [_vehicle, [-1.08, -1.6, 0.35]];};

	
	case "B_Heli_Light_01_F": 			{	_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};
	case "B_Heli_Transport_01_F": 		{	_lightleft lightAttachObject [_vehicle, [-0.5, 0.0, 0.6]];};//Ghosthawk
	case "I_Heli_light_03_unarmed_F": 	{	_lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.56]];};//Hellcat
	case "I_Heli_Transport_02_F": 		{	_lightleft lightAttachObject [_vehicle, [-0.37, 3, 0.5]];}; //Mohawk
...
switch (typeOf _vehicle) do
{
	case "C_Quadbike_01_F":				{ 	_lightright lightAttachObject [_vehicle, [0.28, 0.8, -0.75]];};
	...
	case "B_Truck_01_covered_F":  		{	_lightright lightAttachObject [_vehicle, [1, 5, -0.46]];};
	case "O_MRAP_02_F":  				{	_lightright lightAttachObject [_vehicle, [1.08, -1.6, 0.35]];};
	case "O_MRAP_02_hmg_F":  			{	_lightright lightAttachObject [_vehicle, [1.08, -1.6, 0.35]];};
