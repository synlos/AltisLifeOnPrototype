...
if(_value > 0) then
{
	[[0,format["Ein Fahrzeug wurde durchsucht und es wurden Drogen und illegale Waren im Wert von $%1 sichergestellt!",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
