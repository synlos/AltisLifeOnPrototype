...
if(count _sellers == 0) exitWith {hint "Hier war schon lange keiner mehr."}; //No data.
...
hint parseText format["Die folgenden Personen waren vor kurzem hier.<br/><br/>%1",_names];
