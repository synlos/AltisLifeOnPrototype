...
switch (_state) do
{
	...
	case 2:
	{
		if(license_civ_driver OR license_civ_air OR license_civ_truck OR license_civ_boat) then {
			...
			hint "Da du jemanden überfahren hast, wurden dir sämtliche Führerscheine entzogen!";
		};
	};
	...
	case 3:
	{
		if(license_civ_gun) then {
			license_civ_gun = false;
			hint "Da du jemanden erschossen hast, wurde dir die Waffenlizenz entzogen!";
		};
	};
};