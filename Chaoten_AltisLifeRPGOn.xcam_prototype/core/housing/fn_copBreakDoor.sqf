...
if(_door == 0) exitWith {hint "Du bist nicht nah genug an der Tür."};
if((_house getVariable[format["bis_disabled_Door_%1",_door],0]) == 0) exitWith {hint "Die Tür ist bereits aufgeschlossen!"};

life_action_inUse = true;

//Setup the progress bar
disableSerialization;
_title = "Knacke das Schloss..";
...
[[2,format["%1 Die Polizei durchsucht gerade dein Haus.",(_house getVariable "house_owner") select 1]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
