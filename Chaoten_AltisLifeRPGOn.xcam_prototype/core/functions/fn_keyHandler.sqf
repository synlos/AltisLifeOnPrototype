...
switch (_code) do
{
	...
	case 35:
	{
		...
		if(!_alt && !_ctrlKey && !_shift && playerSide == civilian && !dialog && !life_action_inUse && vehicle player == player) then
		{
