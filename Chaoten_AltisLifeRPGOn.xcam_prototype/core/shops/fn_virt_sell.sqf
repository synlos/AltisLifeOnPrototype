...
if(!([_amount] call fnc_isnumber)) exitWith {hint "Du hast keinen gültigen Wert eingegeben";};
_amount = parseNumber (_amount);
if(_amount > (missionNameSpace getVariable _var)) exitWith {hint "Die Menge, die verkaufen möchtest, besitzt du nicht!"};
