...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["Es befinden sich keine Fahrzeuge in der Nähe, die verkauft werden können!.","PLAIN"];};
if(!(createDialog "Chop_Shop")) exitWith {hint "Fehler beim öffnen des Chop Shop Menüs.."};
