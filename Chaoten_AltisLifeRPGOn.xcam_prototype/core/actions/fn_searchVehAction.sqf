...
if((_vehicle isKindOf "Car") || !(_vehicle isKindOf "Air") || !(_vehicle isKindOf "Ship")) then
{
	...
	if(isNil {_owners}) exitWith {hint "Dieses Fahrzeug enthält keine Informationen, es wurde vieleicht gecheatet! \n\nDeleting vehicle."; deleteVehicle _vehicle;};
	life_action_inUse = true;
	hint "Durchsuche das Fahrzeug...";
	sleep 3;
	...
	//if(isNil {_inventory}) then {_inventory = "Das Fahrzeug ist leer."};
