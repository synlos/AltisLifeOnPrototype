...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	//if(isNil {_time}) exitWith {deleteVehicle _vehicle; hint "Das Fahrzeug wurde vermutlich gehacked und wurde daher gelöscht."};
	//if((time - _time)  < 120) exitWith {hint "Das Fahrzeug wurde erst vor Kurzem ausgeparkt. Daher darfst du es nicht beschlagnahmen."};
