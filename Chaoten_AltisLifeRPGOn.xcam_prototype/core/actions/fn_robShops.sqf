...
if(side _robber == west) exitWith { hint "Du bist ein Cop! " };// We do not want anyone but civilianz to rob the stations.
if(side _robber == independent) exitWith { hint "Du bist ein Arzt! " };// We do not want anyone but civilianz to rob the stations.
