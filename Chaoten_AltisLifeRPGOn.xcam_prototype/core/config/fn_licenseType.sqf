...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "meth": {_var = "license_civ_meth"}; // ur new mwth 1
			case "meth1": {_var = "license_civ_meth"}; // ur new mwth 2
			case "meth2": {_var = "license_civ_meth"}; // ur new mwth 3
			case "lawyer": {_var = "license_civ_lawyer"}; // Anwalt
			case "adac": {_var = "license_civ_adac"}; //##33 ADAC
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_meth": {_var = "meth"}; // ur new meth 1
			case "license_civ_meth": {_var = "meth1"}; // ur new meth 2
			case "license_civ_meth": {_var = "meth2"}; // ur new meth 3
			case "license_civ_lawyer": {_var = "lawyer"}; // Anwalt
			case "license_civ_adac": {_var = "adac"}; //##10 ADAC
